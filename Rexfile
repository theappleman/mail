...
set group => "servers" => "maple.condi.me", "azolla.0xdc.host" => { "user" => "apple" };
...
batch "mail", "acme:install", "portage:files", "mysql:install", "nmail:user", "nmail:postfix", "nmail:dovecot", "nginx:install", "Oxdc:install", "nmail:opendkim";
